        ...
        {success ? (
          <div className="space-y-4">
            <div className="flex items-start gap-2 rounded-md border border-emerald-500/30 bg-emerald-500/10 px-3 py-3 text-sm text-emerald-700 dark:text-emerald-300">
              ...
              <div>
                ...
                <p className="mt-1 text-xs opacity-80">A redirecionar para o login...</p>
              </div>
            </div>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-[var(--color-muted-foreground)]">Mínimo de 8 caracteres</p>
            </div>
            ...
            <Button
              type="submit"
              className="w-full border-0 bg-gradient-to-r from-blue-400 to-emerald-400 text-white hover:from-blue-500 hover:to-emerald-500"
              disabled={loading}
            >
              {loading ? (
                <>
