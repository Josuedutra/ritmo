...
import { Lock, ArrowRight, Send, CheckCircle, Target, Clock, BarChart3 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Card className="relative overflow-hidden border-purple-500/20 bg-gradient-to-br from-purple-500/5 to-transparent">
        <CardContent className="py-12 text-center">
          ...
          <h2 className="mb-2 text-xl font-semibold">Relatórios Avançados</h2>
          <p className="mx-auto mb-6 max-w-md text-[var(--color-muted-foreground)]">
            Acompanhe o desempenho da sua equipa com métricas detalhadas. Veja tendências, taxas de
            conversão e identifique oportunidades.
          </p>
      ...
      <div className="relative">
        <div className="pointer-events-none opacity-60 blur-sm select-none">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <PreviewKPI title="Envios" value="24" icon={<Send className="h-5 w-5" />} />
            <PreviewKPI
            ...
            />
            <PreviewKPI title="Sem Resposta >24h" value="3" icon={<Clock className="h-5 w-5" />} />
          </div>
        </div>
  ...
  return (
    <Card>
      <CardContent className="pt-6">
        <div className="w-fit rounded-lg bg-[var(--color-muted)] p-2">{icon}</div>
        <div className="mt-4">
