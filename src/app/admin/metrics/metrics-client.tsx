    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <MetricCard
          ...
          value={
            metrics.medianTimeToAhaSeconds ? formatDuration(metrics.medianTimeToAhaSeconds) : "N/A"
          }
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-end justify-between">
              ...
              <StatusIndicator value={metrics.activationRate5m} target={targets.activationRate5m} />
            </div>
  ...
  return (
    <Card>
      <CardContent className="pt-6">
        ...
        {target && <p className="mt-1 text-xs text-[var(--color-muted-foreground)]">{target}</p>}
      </CardContent>
    </Card>
  );
}
    ...
    <div className="flex h-32 items-end gap-1">
      {data.map((d) => (
        <div key={d.date} className="group relative flex-1">
          ...
          />
          <div className="absolute bottom-full left-1/2 mb-1 hidden -translate-x-1/2 rounded bg-[var(--color-foreground)] px-2 py-1 text-xs whitespace-nowrap text-[var(--color-background)] group-hover:block">
            {d.date}: {d.count}
          </div>
        </div>
      ))}
