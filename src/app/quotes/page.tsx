        ...
        {counts.all > 0 && (
          <div className="mb-6 flex flex-wrap gap-2">
            {FILTERS.map((f) => {
              ...
              return (
                <Link key={f.id} href={f.id === "all" ? "/quotes" : `/quotes?filter=${f.id}`}>
                  <Button
                  ...
                  >
                    ...
                    <span
                      className={`rounded-full px-1.5 py-0.5 text-xs ${
                        isActive ? "bg-white/20" : "bg-[var(--color-muted)]"
                      }`}
                    >
                      {count}
                    </span>
          ...
          <div className="space-y-3">
            {quotes.map((quote) => {
              ...
              return (
                <Card
                  key={quote.id}
                  className="p-4 transition-colors hover:border-[var(--color-border-hover)]"
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      {isNoResponseFilter && <GenerateActionButton quoteId={quote.id} />}
                      {formattedValue && (
