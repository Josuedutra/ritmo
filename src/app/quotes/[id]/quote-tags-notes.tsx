...
const QUICK_TAGS = [
  ...
  },
  {
    ...
    label: "Obra",
    color:
      "text-[var(--color-info-foreground)] border-[var(--color-info)]/30 bg-[var(--color-info-muted)]",
  },
  {
    id: "manutencao",
    label: "Manutenção",
    color: "text-green-600 border-green-300 bg-green-500/10",
  },
      ...
      <CardContent className="space-y-4 pt-0">
        ...
        <div>
          ...
          {notes.length > 0 ? (
            ...
            !showNoteInput && (
              <p className="text-sm text-[var(--color-muted-foreground)]">Nenhuma nota registada</p>
            )
          )}
        </div>
      </CardContent>
