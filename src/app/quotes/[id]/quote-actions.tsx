  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {/* Copy summary button */}
        {(isSent || isNegotiation) && (
          <Button variant="ghost" onClick={handleCopySummary} className="gap-1.5">
      ...
      {showLossReasonModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-sm rounded-lg bg-[var(--color-background)] p-4 shadow-lg">
            ...
            <p className="mb-3 text-sm text-[var(--color-muted-foreground)]">Motivo (opcional):</p>
            ...
            <div className="mb-4 space-y-2">
              {LOSS_REASONS.map((reason) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setSelectedLossReason(reason.id === selectedLossReason ? null : reason.id)
                  }
