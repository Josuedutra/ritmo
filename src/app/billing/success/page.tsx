      ...
      >
        <div className="py-4">
          <div className="animate-pulse space-y-3">
            <div className="mx-auto h-4 w-3/4 rounded bg-[var(--color-muted)]" />
            <div className="mx-auto h-4 w-1/2 rounded bg-[var(--color-muted)]" />
          </div>
        </div>
        ...
        {showSlowLoadingHint && (
          <div className="mt-6 border-t border-[var(--color-border)] pt-6">
            <p className="mb-4 text-sm text-[var(--color-muted-foreground)]">
              A confirmação está a demorar mais do que o esperado. O seu pagamento foi processado
              com sucesso.
            </p>
