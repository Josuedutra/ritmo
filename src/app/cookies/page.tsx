    ...
    <div className="min-h-screen bg-[var(--color-background)]">
      <div className="container-app py-16">
        ...
        <p className="mb-8 text-[var(--color-muted-foreground)]">
          <strong className="text-[var(--color-foreground)]">Última atualização:</strong> Janeiro
          2026
        </p>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-[var(--color-muted-foreground)]">
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              para o funcionamento da aplicação. Estes cookies são essenciais para:
            </p>
            <ul className="mb-3 list-disc space-y-1 pl-6">
              <li>
                <strong className="text-[var(--color-foreground)]">Autenticação e sessão:</strong>{" "}
                Manter a sua sessão ativa enquanto navega na aplicação, permitindo que permaneça
                autenticado.
              </li>
              <li>
                <strong className="text-[var(--color-foreground)]">Segurança:</strong> Proteção
                contra ataques CSRF (Cross-Site Request Forgery) e outras vulnerabilidades de
                segurança.
              </li>
              <li>
                <strong className="text-[var(--color-foreground)]">Preferências funcionais:</strong>{" "}
                Armazenar preferências essenciais como o tema da interface (claro/escuro).
              </li>
            </ul>
            ...
            <div className="mt-6 rounded-lg border border-[var(--color-border)] bg-[var(--color-muted)]/20 p-6">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <code className="rounded bg-[var(--color-muted)] px-1.5 py-0.5 text-[var(--color-foreground)]">
          ...
          <section>
            ...
            <p className="mb-3">
              Atualmente,{" "}
              <strong className="text-[var(--color-foreground)]">
                não utilizamos cookies de marketing, analytics ou publicidade de terceiros
              </strong>
              . Não partilhamos dados com plataformas de publicidade nem utilizamos ferramentas de
              tracking como Google Analytics, Meta Pixel, ou similares.
            </p>
            <p className="text-sm italic">
              Esta política pode ser atualizada se no futuro adicionarmos ferramentas de analytics
              ou marketing. Quaisquer alterações serão refletidas nesta página.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Pode gerir ou eliminar cookies através das definições do seu navegador. No entanto, se
              bloquear os cookies essenciais, algumas funcionalidades do Ritmo podem não funcionar
              corretamente (por exemplo, não conseguirá manter a sessão iniciada).
            </p>
            <p className="mb-3">
              Para mais informações sobre como gerir cookies, consulte a documentação do seu
              navegador:
            </p>
          ...
          <section>
            ...
            <p>
              Se tiver dúvidas sobre a nossa utilização de cookies, pode contactar-nos através de{" "}
              <a
