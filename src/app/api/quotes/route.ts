...
import { getApiSession, unauthorized, badRequest, serverError, success } from "@/lib/api-utils";
...
const createQuoteSchema = z.object({
  contactId: z.preprocess(emptyToNull, z.string().uuid().optional().nullable()),
  ...
  proposalLink: z.preprocess(emptyToNull, z.string().url().optional().nullable()),
