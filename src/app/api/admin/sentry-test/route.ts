...
import { getApiSession, unauthorized, serverError, success } from "@/lib/api-utils";
import { setSentryRequestContext, captureMessage } from "@/lib/observability/sentry-context";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const sentryEventId = captureMessage("sentry_test_ok", "info", {
      requestId,
      extra: {
