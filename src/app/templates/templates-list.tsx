            ...
            <Card key={template.id} className={isEditing ? "ring-2 ring-[var(--color-primary)]" : ""}>
                <CardHeader className="pb-3">
                    <div className="flex items-start justify-between gap-2">
                        ...
                        <Badge variant={info?.type === "call" ? "success" : template.isActive ? "default" : "secondary"}>
                            {badgeLabel}
                        </Badge>
                    </div>
                </CardHeader>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {PLACEHOLDERS.map((p) => (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 rounded-md border border-[var(--color-border)] bg-[var(--color-background)] px-2.5 py-1 text-xs font-medium transition-colors hover:bg-[var(--color-accent)] hover:border-[var(--color-primary)]"
                                title={p.description}
                            >
