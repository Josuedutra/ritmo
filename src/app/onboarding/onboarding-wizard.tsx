  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--color-background)] p-4">
      <div className="w-full max-w-2xl">
                  ...
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold transition-all duration-300 ${
                      index < currentStep
                        ...
                        : index === currentStep
                          ? "bg-gradient-to-r from-[var(--color-brand-from)] to-[var(--color-brand-to)] text-white shadow-[var(--color-brand-from)]/30 shadow-lg ring-4 ring-[var(--color-brand-from)]/20"
                ...
                {index < STEPS.length - 1 && (
                  <div
                    className={`mx-2 mt-[-20px] h-1 w-12 rounded-full transition-colors duration-300 ${
                      index < currentStep ? "bg-green-500" : "bg-[var(--color-muted)]"
                    }`}
                  />
                )}
              </div>
        ...
        <Card className="overflow-hidden border-[var(--color-border)] shadow-2xl shadow-black/5">
          {/* Step 0: Welcome */}
          {currentStep === 0 && (
            <>
              <CardContent className="p-8">
                <div className="text-center">
                  <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-[var(--color-primary)] shadow-[var(--color-primary)]/25 shadow-lg">
                    ...
                    {[
                      {
                        ...
                        timing: "D+1",
                        type: "Email",
                        desc: "Verificar se recebeu a proposta",
                      },
                      {
                        code: "T3",
                        name: "Interesse",
                        timing: "D+3",
                        type: "Email",
                        desc: "Esclarecer dúvidas pendentes",
                      },
                      {
                        code: "CALL",
                        name: "Chamada",
                        timing: "D+7",
                        type: "Chamada",
                        desc: "Contacto direto para decisão",
                      },
                      {
                        code: "T5",
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Badge
                            variant="outline"
                            className="min-w-[45px] justify-center font-mono text-xs"
                          >
                            {t.timing}
                          </Badge>
                          <div>
                        ...
                        <Badge
                          variant={t.type === "Chamada" ? "default" : "secondary"}
                          className="text-xs"
                        >
                          {t.type}
                        </Badge>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className={`w-full rounded-xl border-2 p-5 text-left transition-all duration-200 ${
                      smtpChoice === "ritmo"
                        ? "border-[var(--color-primary)] bg-[var(--color-primary)]/5 shadow-[var(--color-primary)]/10 shadow-md"
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      >
                        {smtpChoice === "ritmo" && <Check className="h-4 w-4 text-white" />}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <span className="text-base font-semibold">Enviar via Ritmo</span>
                          <Badge className="border-[var(--color-primary)]/30 bg-[var(--color-primary)]/10 text-xs text-[var(--color-primary)]">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      >
                        {smtpChoice === "own" && <Check className="h-4 w-4 text-white" />}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {hasSmtp && (
                            <Badge className="border-green-500/30 bg-green-500/10 text-xs text-green-600">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-[var(--color-muted-foreground)]">
                          Os emails saem do seu domínio (ex: comercial@suaempresa.pt). Maior
                          reconhecimento e taxa de abertura.
                        </p>
                          ...
                          <div className="mt-4">
                            <Alert className="border-[var(--color-info)]/30 bg-[var(--color-info)]/5">
                              ...
                              <AlertDescription className="ml-2 text-sm">
                                ...
                                <span className="mt-1 block text-[var(--color-muted-foreground)]">
                                  Configure as credenciais do seu servidor de email para usar esta
                                  opção.
                                </span>
              ...
              <CardContent className="p-8">
                <div className="space-y-6">
                  <p className="leading-relaxed text-[var(--color-muted-foreground)]">
                    Ao enviar uma proposta, adicione este endereço em BCC. O Ritmo captura
                    automaticamente o PDF ou link para referência rápida.
                  </p>

                  <div className="rounded-xl border-2 border-dashed border-[var(--color-border)] bg-[var(--color-muted)]/30 p-4">
                    <label className="mb-2 block text-xs font-medium tracking-wide text-[var(--color-muted-foreground)] uppercase">
                      Endereço BCC exclusivo da sua conta
                    </label>
                    <div className="flex items-center gap-3">
                      <code className="flex-1 rounded-lg border border-[var(--color-border)] bg-[var(--color-background)] px-4 py-3 font-mono text-sm select-all">
                        {bccEmail}
                      </code>
                      <Button
                  ...
                  <div className="space-y-3">
                    <details className="group rounded-lg border border-[var(--color-border)] bg-[var(--color-background)]">
                      ...
                      <div className="border-t border-[var(--color-border)] px-4 py-3 text-sm text-[var(--color-muted-foreground)]">
                        BCC (Blind Carbon Copy) é uma cópia oculta do email. O destinatário não vê
                        os endereços em BCC, por isso é ideal para capturar as suas propostas sem
                        que o cliente saiba.
                      </div>
                    </details>
                    <details className="group rounded-lg border border-[var(--color-border)] bg-[var(--color-background)]">
                      ...
                      <div className="border-t border-[var(--color-border)] px-4 py-3 text-sm text-[var(--color-muted-foreground)]">
                        Não. O BCC é completamente invisível para o destinatário. Apenas o Ritmo
                        recebe a cópia para capturar a proposta.
                      </div>
                    </details>
                    <details className="group rounded-lg border border-[var(--color-border)] bg-[var(--color-background)]">
                      <summary className="flex cursor-pointer items-center justify-between p-4 text-sm font-medium">
                      ...
                      <div className="border-t border-[var(--color-border)] px-4 py-3 text-sm text-[var(--color-muted-foreground)]">
                        Configure uma regra no seu cliente de email (Outlook, Gmail, etc.) para
                        adicionar este BCC automaticamente às mensagens com &quot;proposta&quot; ou
                        &quot;orçamento&quot; no assunto.
                      </div>
                    </details>
                  </div>
                      ...
                      <div className="py-4">
                        ...
                        {verifyStatus === "not_found" && (
                          <div className="text-center">
                            ...
                            <h3 className="mb-2 font-semibold">Nenhuma captura encontrada</h3>
                            <p className="mb-4 text-sm text-[var(--color-muted-foreground)]">
                              Ainda não recebemos nenhum email em BCC. Envie um email de teste para
                              o endereço BCC e volte a verificar.
                            </p>
                            <Button
                              variant="outline"
                        ...
                        {verifyStatus === "trial_limit" && (
                          <div className="text-center">
                            ...
                            <p className="mb-4 text-sm text-[var(--color-muted-foreground)]">
                              Durante o período de trial, pode capturar 1 proposta via BCC. Para
                              capturas ilimitadas, faça upgrade para um plano pago.
                            </p>
                        ...
                        {verifyStatus === "error" && (
                          <div className="text-center">
                            ...
                            <h3 className="mb-2 font-semibold text-red-600">Erro ao verificar</h3>
                            <p className="mb-4 text-sm text-[var(--color-muted-foreground)]">
            ...
            <>
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <p className="mx-auto mb-4 max-w-md leading-relaxed text-[var(--color-muted-foreground)]">
                    A sua conta está pronta. Crie o primeiro orçamento para ativar o follow-up
                    automático.
                  </p>
                  <p className="mx-auto mb-8 max-w-md text-sm text-[var(--color-muted-foreground)]">
                  ...
                  <div className="mb-8 rounded-xl border border-[var(--color-border)] bg-[var(--color-muted)]/20 p-1 text-left">
                    <div className="divide-y divide-[var(--color-border)]">
                      <div className="flex items-center justify-between p-4">
                        ...
                        <Badge
                          variant={hasTemplates ? "default" : "secondary"}
                          className={hasTemplates ? "bg-green-500" : ""}
                        >
