      ...
      <div className="container-app py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-[var(--color-muted-foreground)]">
          ...
          <section>
            ...
            <p className="mb-3">
              O Serviço está disponível em diferentes planos, incluindo um plano gratuito com
              funcionalidades limitadas e planos pagos com recursos adicionais.
            </p>
            <h3 className="mb-2 text-lg font-medium text-[var(--color-foreground)]">
              4.1 Período de Trial
            </h3>
            <p className="mb-3">
              Novos utilizadores têm acesso a um período de trial de 14 dias sem necessidade de
              cartão de crédito. Após o trial, a conta reverte para o plano gratuito ou pode fazer
            ...
            <p className="mb-3">
              Os planos pagos são faturados mensalmente, com cobrança automática no início de cada
              período. Os preços apresentados incluem IVA à taxa legal em vigor.
            </p>
            <h3 className="mb-2 text-lg font-medium text-[var(--color-foreground)]">
              4.3 Cancelamento
            </h3>
            <p>
              Pode cancelar a subscrição a qualquer momento através das definições da conta. O
              acesso aos recursos pagos mantém-se até ao final do período já pago. Não são efetuados
              reembolsos por períodos não utilizados.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              O utilizador compromete-se a utilizar o Serviço de forma lícita e de acordo com estes
          ...
          <section>
            ...
            <p className="mb-3">
              Todo o conteúdo do Serviço, incluindo mas não limitado a software, design, logótipos,
              textos e gráficos, é propriedade de [NOME LEGAL DA EMPRESA] ou dos seus licenciadores,
              estando protegido por direitos de autor e outras leis de propriedade intelectual.
            </p>
            <p>
              O utilizador mantém todos os direitos sobre os dados e conteúdos que introduz na
              plataforma. Ao utilizar o Serviço, concede-nos uma licença limitada para processar
          ...
          <section>
            ...
            <p className="mb-3">
              A recolha e tratamento de dados pessoais é efetuada em conformidade com o Regulamento
              Geral sobre a Proteção de Dados (RGPD) e demais legislação aplicável.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              O Serviço é fornecido &quot;tal como está&quot; e &quot;conforme disponível&quot;. Na
              máxima extensão permitida por lei, não garantimos:
            </p>
            <ul className="mb-3 list-disc space-y-1 pl-6">
            ...
            <p>
              Em caso algum seremos responsáveis por danos indiretos, incidentais, especiais ou
              consequenciais, incluindo perda de lucros, dados ou oportunidades de negócio.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              serão publicadas nesta página com indicação da data de atualização.
            </p>
            <p>
              Alterações significativas serão notificadas por email ou através da plataforma com
              pelo menos 30 dias de antecedência. A continuação da utilização do Serviço após as
          ...
          <section>
            ...
            <p className="mb-3">
              Estes Termos são regidos pela lei portuguesa. Para a resolução de qualquer litígio
              decorrente da utilização do Serviço, as partes submetem-se à jurisdição exclusiva dos
              tribunais portugueses, com renúncia a qualquer outro foro.
            </p>
            <p>
              Em caso de conflito entre versões destes Termos em diferentes idiomas, prevalece a
              versão em português.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Se alguma disposição destes Termos for considerada inválida ou inexequível, as
              restantes disposições mantêm-se em pleno vigor.
            </p>
            <p>
              A não aplicação de qualquer direito ou disposição destes Termos não constitui renúncia
