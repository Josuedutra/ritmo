    ...
    <div className="min-h-screen bg-[var(--color-background)]">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="mx-auto max-w-3xl text-4xl leading-tight font-bold md:text-5xl">
            Parcerias para <span className="text-[var(--color-primary)]">Contabilidades</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[var(--color-muted-foreground)]">
            Ajude os seus clientes a transformar orçamentos em vendas e receba uma comissão por cada
            cliente indicado que subscreva.
          </p>
      ...
      <section className="border-t border-[var(--color-border)] bg-[var(--color-muted)]/30 py-20">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center text-2xl font-bold">Porquê recomendar o Ritmo?</h2>
          <div className="grid gap-8 md:grid-cols-3">
            {/* Benefit 1 */}
            <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-6">
              <div className="bg-success mb-4 inline-flex rounded-lg p-3">
              ...
              <p className="text-sm text-[var(--color-muted-foreground)]">
                Os seus clientes deixam de perder oportunidades por falta de follow-up. O Ritmo
                automatiza lembretes em D+1, D+3, D+7 e D+14.
              </p>
            </div>

            {/* Benefit 2 */}
            <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-6">
              <div className="bg-info mb-4 inline-flex rounded-lg p-3">
                <Building2 className="text-info h-6 w-6" />
              </div>
              <h3 className="mb-2 text-lg font-semibold">Clientes com receita mais previsível</h3>
              <p className="text-sm text-[var(--color-muted-foreground)]">
                Empresas que fecham mais negócios têm cash flow mais estável. Isso significa menos
                stress para si e para eles.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-6">
              ...
              <p className="text-sm text-[var(--color-muted-foreground)]">
                Sem CRM pesado para configurar. O cliente começa a usar em 2 minutos. Marca o
                orçamento como enviado e o follow-up é automático.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center text-2xl font-bold">Como funciona a parceria</h2>
          <div className="mx-auto max-w-3xl">
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute top-0 left-6 h-full w-0.5 bg-[var(--color-border)]" />
              ...
              <div className="relative mb-8 pl-16">
                ...
                <p className="text-sm text-[var(--color-muted-foreground)]">
                  Envie-nos um email e criamos um link exclusivo para a sua contabilidade em menos
                  de 24 horas.
                </p>
              </div>
              ...
              <div className="relative mb-8 pl-16">
                ...
                <p className="text-sm text-[var(--color-muted-foreground)]">
                  Quando um cliente precisa de organizar os orçamentos ou quer melhorar o follow-up
                  comercial, partilhe o link.
                </p>
              </div>
              ...
              <div className="relative mb-8 pl-16">
                ...
                <p className="text-sm text-[var(--color-muted-foreground)]">
                  ...
                  <strong>15% do valor do primeiro pagamento</strong>. Sem limite de clientes.
                </p>
              </div>
              ...
              <div className="relative pl-16">
                ...
                <p className="text-sm text-[var(--color-muted-foreground)]">
                  Veja quantos clientes se registaram através do seu link e o valor das comissões
                  pendentes e pagas.
                </p>
              </div>
            </div>
      ...
      <section className="border-t border-[var(--color-border)] py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 text-center text-2xl font-bold">Regras do Programa</h2>
          <div className="mx-auto max-w-2xl space-y-6">
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-4">
              <h3 className="mb-2 font-semibold">Janela de Atribuição</h3>
              <p className="text-sm text-[var(--color-muted-foreground)]">
                A atribuição é válida por <strong>30 dias</strong> após o clique no link de
                parceiro. Se o cliente criar conta dentro deste período, a referência é registada.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-4">
              ...
              <p className="text-sm text-[var(--color-muted-foreground)]">
                O booster corresponde a <strong>15% do primeiro pagamento</strong> (uma vez) quando
                o cliente indicado ativa um plano pago. Exemplo: se o cliente subscreve o plano
                Starter a €39/mês, o booster é de €5,85.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-4">
              ...
              <p className="text-sm text-[var(--color-muted-foreground)]">
                Os boosters ficam no estado <strong>PENDING</strong> até serem processados
                manualmente pelo admin e marcados como <strong>PAID</strong>. Os pagamentos são
                feitos por transferência bancária após confirmação do valor acumulado.
              </p>
            </div>
