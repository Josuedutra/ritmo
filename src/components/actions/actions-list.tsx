            ...
            <div className="mt-6">
              ...
              >
                <div className="flex flex-col items-start">
                  <span className="text-sm font-medium">{getEventLabel(nextAction.eventType)}</span>
                  <span className="text-xs text-[var(--color-muted-foreground)]">
                    {nextAction.quoteTitle} ·{" "}
                    {formatDistanceToNow(new Date(nextAction.scheduledFor), {
                      addSuffix: true,
                      locale: pt,
                    })}
                  </span>
    ...
    return (
      <div className="py-6">
        ...
        <div className="mt-6 flex flex-col items-center gap-3">
          <Button onClick={handleCreateExample} disabled={creatingExample} className="gap-2">
            {creatingExample ? (
