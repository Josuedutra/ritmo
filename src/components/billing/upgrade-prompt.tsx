...
export function UpgradePrompt({
  ...
  const ctaLabel =
    customCtaLabel || (recommendedPlan === "pro_plus" ? "Pedir acesso" : preset.ctaLabel);
      ...
      <div className={variantStyles.modal}>
        <div className="w-full max-w-md rounded-lg bg-[var(--color-background)] p-6 shadow-xl">
          ...
          <div className="mt-6 flex justify-end gap-3">
            ...
            <Button onClick={handleCtaClick} disabled={isLoading} className="gap-1.5">
              {isLoading ? (
                <>
...
export const UPGRADE_PROMPTS = {
  ...
  retention_expired: {
    ...
    bullets: ["Guarde propostas por mais tempo", "Acesso ao histórico quando precisa"],
    ctaLabel: "Ver planos",
  },
  seat_limit: {
    title: "Limite de utilizadores",
    message: "Este plano não permite adicionar mais utilizadores.",
    bullets: ["Traga a equipa para o Ritmo", "Mais controlo e permissões"],
    ctaLabel: "Adicionar lugares",
  },
  benchmark_locked: {
    title: "Benchmark bloqueado",
    message: "Benchmark é exclusivo do Pro+.",
    bullets: ["Compare com o seu setor", "Metas e ranking"],
