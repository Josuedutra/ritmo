      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="relative">
          <div className="flex flex-col items-center py-4 text-center">
            ...
            <p className="mb-1 text-sm font-medium">Compare o seu desempenho com o mercado</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center py-4 text-center">
            ...
            <p className="mb-3 text-sm text-[var(--color-muted-foreground)]">{data.message}</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center py-4 text-center">
            ...
            <p className="text-sm text-[var(--color-muted-foreground)]">{data.message}</p>
          </div>
        </CardContent>
      </Card>
    );
...
function BenchmarkMetric({
  ...
  const getPosition = () => {
    ...
    if (value >= p50)
      return { label: "Acima da média", color: "text-[var(--color-info)]", icon: TrendingUp };
    if (value >= p50 * 0.8)
      return { label: "Média", color: "text-[var(--color-muted-foreground)]", icon: Minus };
