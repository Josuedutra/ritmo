    ...
    startTransition(async () => {
      try {
        ...
        toast({
          title: "Sucesso",
          description:
            "Definições guardadas com sucesso. A nova cadência respeitará estes horários.",
        });
      } catch (error) {
        toast({
          variant: "error",
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-muted-foreground text-xs">
                    Usado para comparar o seu desempenho com outras empresas do mesmo setor
                    (Benchmark).
                  </p>
                  <FormMessage />
                </FormItem>
            ...
            <div className="bg-muted text-muted-foreground rounded-md p-3 text-sm">
              <p>
                O Ritmo apenas enviará emails automáticos entre as {form.watch("sendWindowStart")}
                :00 e as {form.watch("sendWindowEnd")}:00 do fuso horário selecionado. Envs fora
                deste horário serão agendados para a próxima janela disponível.
              </p>
            </div>
