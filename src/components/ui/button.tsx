  ...
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    return (
      <button
        className={cn(
          // Base styles
          "inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap transition-all duration-200",
          "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-background)] focus-visible:outline-none",
          ...
          variant === "brand" && [
            ...
            "font-semibold text-[var(--color-brand-foreground)]",
            "shadow-[var(--color-brand-from)]/25 shadow-md",
            "hover:-translate-y-0.5 hover:shadow-[var(--color-brand-from)]/30 hover:shadow-lg",
