  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-[var(--color-sidebar)]">
      <div className="container-app flex h-14 items-center justify-between">
        ...
        <Link
          href="/dashboard"
          className="bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-2xl font-bold tracking-tight text-transparent transition-opacity hover:opacity-80"
        >
          Ritmo
        </Link>
