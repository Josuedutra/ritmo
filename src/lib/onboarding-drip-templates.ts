...
export function onboardingEmail1(params: { userName?: string }): { html: string; text: string; subject: string } {
...
export function onboardingEmail2(params: { userName?: string }): { html: string; text: string; subject: string } {
    const greeting = params.userName ? `Olá ${params.userName},` : "Olá,";
...
export function onboardingEmail3(params: { userName?: string }): { html: string; text: string; subject: string } {
    const greeting = params.userName ? `Olá ${params.userName},` : "Olá,";
...
export function onboardingEmail4(params: { userName?: string }): { html: string; text: string; subject: string } {
    const greeting = params.userName ? `Olá ${params.userName},` : "Olá,";
...
export function onboardingEmail5(params: { userName?: string }): { html: string; text: string; subject: string } {
    const greeting = params.userName ? `Olá ${params.userName},` : "Olá,";
